...
<div class="card mt-3">
  ...
  <div class="card-body">
    <a href="?halaman=arsip_surat&hal=tambahdata" class="btn btn-warning mb-3 hide">Tambah Data</a>
    ...
    <table class="table table-borderd table-hovered table-striped">
        ...
        <tr>
            ...
            <td class="hide">
              ...
              <a href="?halaman=arsip_surat&hal=hapus&id=<?=$data['id_arsip']?>" class="btn btn-danger" onclick="return confirm('apakah anda ingin menghapus data ini')">Hapus</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
